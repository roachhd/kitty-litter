 ...
 *  Description: A responsive gallery for your projects on Github
 *  URL: https://github.com/roachhd/kitty-litter 
 *  Author: Katie Ball
 *  License: MIT 
 */
...
;(function ( $, window, document, undefined ) {
    ...
    $.fn.kittyLitter = function ( options ) {
        return this.each(function () {
            if (!$.data(this, 'plugin_' + kittyLitter)) {
                $.data(this, 'plugin_' + kittyLitter, new Plugin( this, options ));
            }
        });
    }
